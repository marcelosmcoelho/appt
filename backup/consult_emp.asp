...
if logar=4 and bloq_empree<>1 and bloqueio_uni<>1 then
     ...
     encontrou="S"
	 resp=""
     resp=resp  & "{" & chr(34) & "logou" & chr(34) & ":" & chr(34) & encontrou & chr(34) & "," & chr(34) & "id_cliente" & chr(34) & ":" & chr(34) & id_cliente & chr(34) & "," & chr(34) & "id_empree" & chr(34) & ":" & chr(34) & id_empree & chr(34) & "," & chr(34) & "nome_empree" & chr(34) & ":" & chr(34) & nome_empree & chr(34) & "," & chr(34) & "e_construtora" & chr(34) & ":" & chr(34) & e_construtora & chr(34) & "," & chr(34) & "data_implantacao_sc" & chr(34) & ":" & chr(34) & formata_data3(data_implantacao_sc) & chr(34) & " }"
