...
<%					
	...
	' jsonstring2="tx=meutextoação&ipm=345&m=117&a=2015"
     ...
     str_ipm=Mid(jsonstring2,pos_ipm,pos_mes-pos_ipm-3)
...
<%
	...
	set fs=Server.CreateObject("Scripting.FileSystemObject")
		...
		set fname=fs.CreateTextFile("e:/home/newdot/web/sigmacivil/clientes/" & str_cliente & "/" & aux_econst & "/" & str_ipm & "_" & str_mes & "_" & str_ano & ".txt",true)
...
aUx.Open SQL_buscaaUx,conn 
  ...
  if Not aUx.EOF then
	...
	do while Not aUx.EOF 
		...
		if cstr(q_mes)=cstr(str_mes) and cstr(q_ano)=cstr(str_ano) then
